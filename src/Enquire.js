...
const Enquire = () => {
  ...
  return (
    <div className="absolute top-0 w-full h-screen flex items-center justify-center font-rubik">
      <div className="w-full max-w-lg p-8 rounded-lg">
        ...
        <div className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-customBlue">Name</label>
            <input
          ...
          {/* Email Input */}
          <div>
            <label className="block text-sm font-medium text-customBlue">Email</label>
            <input
              {...register("email", {
                required: true,
                pattern: /^\S+@\S+$/i,
          ...
          {/* Message Input */}
          <div>
            <label className="block text-sm font-medium text-customBlue">Message</label>
            <textarea
          ...
          <div className="flex justify-center">
            ...
            >
              <div className="space-x-2 flex items-center">
                <span className="text-sm text-customBlue font-semibold">Submit</span>
              </div>
            </div>
          </div>
        </div>
